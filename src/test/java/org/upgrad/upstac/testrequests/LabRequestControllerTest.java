...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest tr = labRequestController.assignForLabTest(testRequest.requestId);
        ...
        assertThat(testRequest.getRequestId(), is(equalTo(tr.getRequestId())));
        assertThat(tr.getStatus(), is(RequestStatus.INITIATED));
        assertNotNull(tr.getLabResult());
    ...
    public void calling_updateLabTest_with_valid_test_request_id_should_update_the_request_status_and_update_test_request_details(){
        ...
        TestRequest tr = labRequestController.updateLabTest(testRequest.getRequestId(),createLabResult);
        tr.setStatus(RequestStatus.LAB_TEST_IN_PROGRESS);
